package com.softuni.DeliciousRecipes.web.aop;
...
public class MonitoringAspect {
    ...
    Object monitorExecutionTime(ProceedingJoinPoint pjp) throws Throwable {
        ...
        long threshold = annotation.timeInMillis();
        ...
        if (executionTime > threshold){
            LOGGER.warn("The method {} executed in {} millis which is more than the threshold of {} millis.",
                    pjp.getSignature(),
                    executionTime,
                    threshold);
        }
